...
|--------|-------------|-----------|
| `etl.br__dataset.nucel_accounts` | `status`, `last_payment`, `last_suspension_reason`, `current_port_in_finished_at`, `current_plan_status`, `current_plan_created_at` | `subscription_renewal_date`, `has_active_nucel_plan`, `nucel_plan_status`, `nucel_portability_completed_at` |
